// ==WindhawkMod==
// @id              start-menu-size-ra
// @name            Start Menu Size RA
// @description     Set a custom size for the Start menu and search menu on Windows 11
// @version         1.0
// @author          ricardoambdev
// @github          https://github.com/ricardoambdev
// @twitter         https://twitter.com/ricardoambdev
// @homepage        https://ricardoamb.github.io/
...
// https://github.com/ricardoambdev/windhawk-mods
...
// Cached padding between FrameRoot and MainMenu (redesigned start menu only).
// Calculated once from ActualWidth diff on first successful apply.
...
void SettingsChanged() {
    // Clear cached padding so it gets recalculated on next apply.
    g_cachedRedesignedPadding.reset();
    ApplyStyle();
}
